...
hl.device({
    name        = "steelseries-steelseries-rival-3-gen-2",
    sensitivity = -0.5,
})
...
local menu        = "rofi -show drun -drun-display-format {name}"
...
hl.on("hyprland.start", function () 
  ...
  hl.exec_cmd("mako")
  hl.exec_cmd("~/.config/hypr/mmb.sh")
end)
...
-- Key passthroughs
hl.bind("mouse:275", hl.dsp.pass({ window = "class:^(discord-canary)$" }))
hl.bind(mainMod .. "+  F1", hl.dsp.pass({ window = "class:^(com.obsproject.Studio)$" }))

-- Screenlock
hl.bind(mainMod .. "+  Escape", hl.dsp.exec_cmd("hyprlock --grace 30"))

-- Wallpaper changer
hl.bind(mainMod .. " + K", hl.dsp.exec_cmd("~/.config/hypr/wallscript.sh 2"))
hl.bind(mainMod .. " + L", hl.dsp.exec_cmd("~/.config/hypr/wallscript.sh 3"))
